...
<video controls width="640" height="360" style="max-width:100%; border:1px solid #ccc; border-radius:4px;">
  <source src="https://raw.githubusercontent.com/lejrimostfa/DemoVideoDnDP2P.mp4" type="video/mp4">
  Votre navigateur ne supporte pas la vidéo HTML5.  
  <a href="https://github.com/lejrimostfa/blob/DemoVideoDnDP2P.mp4">Télécharger la vidéo</a>
</video>
